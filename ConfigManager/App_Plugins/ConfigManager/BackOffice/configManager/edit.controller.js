(function () {
    ...
    function configManagerEditController($scope, $routeParams, configManagerResource, assetsService, notificationsService, editorState, navigationService, appState, macroService, angularHelper, $timeout, contentEditingHelper, localizationService, templateHelper, macroResource) {
        ...
        function save() {
            ...
            contentEditingHelper.contentEditorPerformSave({
                ...
                saveMethod: configManagerResource.saveThemeFile,
                scope: $scope,
        ...
        function completeSave(saved) {
            ...
            if (vm.themeFile.id !== saved.id) {
                ...
                // normal tree sync
                navigationService.syncTree({ tree: "configManager", path: vm.themeFile.path, forceReload: true }).then(function (syncArgs) {
        ...
        function init() {
            ...
            assetsService.loadCss("lib/ace-razor-mode/theme/razor_chrome.css");
                ...
                configManagerResource.getByPath($routeParams.id).then(
                    function (themeFile) {
    ...
    angular.module("umbraco").controller("Articulate.Editors.ThemeEditController", configManagerEditController);
